      ...
      <main className="flex-1 max-w-[95%] mx-auto">
        ...
        <section id="pricing" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-headline font-bold tracking-tighter sm:text-5xl">Our Pricing</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            ...
            <div className="mx-auto grid max-w-5xl items-stretch gap-8 sm:grid-cols-1 lg:grid-cols-3 mt-12">
              <Card className="flex flex-col">
                ...
                <CardContent className="flex-1 space-y-6">
                  <div className="text-4xl font-bold">£499 <span className="text-sm font-normal text-muted-foreground">one-time</span></div>
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" />
                      <span>First Year 'standard' Support Plan included</span>
                    </li>
                  </ul>
                </CardContent>
                <CardFooter>
              ...
              <Card className="flex flex-col border-primary shadow-lg shadow-primary/20 relative">
                ...
                <CardHeader>
                  ...
                  <CardDescription>For growing businesses that need more power and features.</CardDescription>
                </CardHeader>
                <CardContent className="flex-1 space-y-6">
                  <div className="text-4xl font-bold">£999 <span className="text-sm font-normal text-muted-foreground">one-time</span></div>
                   <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" />
                    ...
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" />
                      <span>First Year 'pro' Support Plan included</span>
                    </li>
                  </ul>
                </CardContent>
                <CardFooter>
              ...
              <Card className="flex flex-col">
                <CardHeader>
                  ...
                  <CardDescription>For enterprises with custom needs and high traffic.</CardDescription>
                </CardHeader>
                <CardContent className="flex-1 space-y-6">
