      ...
      <main className="flex-1 max-w-[95%] mx-auto">
        ...
        <section id="pricing" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-headline font-bold tracking-tighter sm:text-5xl">Flexible Pricing for Every Need</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Choose the perfect plan to get your project off the ground.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-6xl items-start gap-8 sm:grid-cols-1 md:grid-cols-3 md:gap-12 mt-12">
              <Card>
                <CardHeader className="space-y-4 text-center">
                  <CardTitle className="font-headline text-2xl">Brochure</CardTitle>
                ...
                <CardContent className="space-y-4">
                  <p className="text-center text-muted-foreground px-4">Perfect for Small Businesses and Individuals</p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" />
                      <span>Secure your foot-hold on the Web</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" />
                      <span>Excellent Foundation for your Web Presence</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" />
                      <span>3-Page Custom Website</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" />
              ...
              <Card className="border-primary shadow-lg shadow-primary/20 relative">
                ...
                <CardContent className="space-y-4">
                  <p className="text-center text-muted-foreground px-4">Ideal for growing businesses that need more power and features.</p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" />
                      <span>Everything in Brochure</span>
                    </li>
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" />
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-center text-muted-foreground px-4">For businesses requiring advanced features and e-commerce.</p>
                  <ul className="space-y-2 text-sm">
                    <li className="flex items-center gap-2">
                      <Check className="h-4 w-4 text-primary" />
